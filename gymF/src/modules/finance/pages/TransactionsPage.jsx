                    ...
                    <div className="relative bg-white/80 backdrop-blur-sm rounded-[2rem] shadow-xl border border-slate-100 p-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <p className="text-slate-500 text-sm font-bold uppercase tracking-widest mt-1">Manage and monitor all payment transactions</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3 w-full sm:w-auto">
                            <button className="flex-1 sm:flex-none h-11 px-6 bg-white text-slate-700 border border-slate-200 rounded-xl text-[11px] font-black uppercase tracking-widest shadow-sm hover:bg-slate-50 transition-all flex items-center justify-center gap-2">
