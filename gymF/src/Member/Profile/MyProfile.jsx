                ...
                <Card className="p-5 sm:p-8 border border-white rounded-2xl sm:rounded-[32px] bg-white shadow-2xl shadow-indigo-100/30 relative overflow-hidden group hover:shadow-indigo-200/40 transition-all duration-500">
                    ...
                    <div className="relative z-10 flex items-center gap-5 sm:gap-10">
                        ...
                        <div className="space-y-2 sm:space-y-3 min-w-0">
                            <div>
                                <h2 className="text-xl sm:text-3xl font-black text-slate-900 tracking-tight leading-none truncate">Demo Member</h2>
                            ...
                            <div className="flex items-center gap-2 sm:gap-3 pt-0.5 sm:pt-1 flex-wrap">
                                <span className="px-2.5 sm:px-4 py-1 sm:py-1.5 bg-emerald-50 text-emerald-600 border border-emerald-100 rounded-full text-[9px] sm:text-[10px] font-black uppercase tracking-[0.1em] shadow-sm whitespace-nowrap">active</span>
                                <span className="px-2.5 sm:px-4 py-1 sm:py-1.5 bg-white text-slate-600 border border-slate-100 rounded-full text-[9px] sm:text-[10px] font-black uppercase tracking-[0.1em] shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group/badge whitespace-nowrap">
                                    Premium Gold Plan
                ...
                <Card className="p-5 sm:p-10 border border-white rounded-2xl sm:rounded-[40px] bg-white shadow-2xl shadow-indigo-100/30 group hover:shadow-indigo-200/40 transition-all duration-500">
                    ...
                    <div className="flex items-center gap-4 sm:gap-6 p-4 sm:p-6 bg-slate-50/50 border border-slate-100 rounded-2xl sm:rounded-3xl group-hover:bg-white transition-colors duration-500">
                        ...
                        <div className="min-w-0">
                            <p className="text-lg sm:text-xl font-black text-slate-900 tracking-tight truncate">Main Branch</p>
