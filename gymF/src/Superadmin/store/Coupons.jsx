...
const Coupons = () => {
    ...
    const statsCards = [
        { label: 'Total Coupons', value: stats.totalCoupons, icon: Ticket, color: 'text-blue-500', bg: 'bg-blue-50' },
    ...
    return (
        <div className="bg-gradient-to-br from-slate-50 via-white to-indigo-50/20 p-4 sm:p-8 min-h-screen">
            {/* Header */}
